...
})(["min-width:600px;min-height:450px;border:0;allowfullscreen=\"\";loading=\"lazy\";@meda ", "{max-width:400px;max-height:300px;}@media ", "{max-width:200px;max-height:150px;}"], function (props) {
  return props.the;
}, function (props) {
