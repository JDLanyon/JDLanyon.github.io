...
export default function Button({text, href = "#", no_border, target_blank, onClick, children} : ButtonProps) {
  return (
  // —————————————————————————————
  // ⠀⣞⢽⢪⢣⢣⢣⢫⡺⡵⣝⡮⣗⢷⢽⢽⢽⣮⡷⡽⣜⣜⢮⢺⣜⢷⢽⢝⡽⣝
  // ⠸⡸⠜⠕⠕⠁⢁⢇⢏⢽⢺⣪⡳⡝⣎⣏⢯⢞⡿⣟⣷⣳⢯⡷⣽⢽⢯⣳⣫⠇
  ...
  // ⠀⠀⠀⠀⠁⠇⠡⠩⡫⢿⣝⡻⡮⣒⢽⠋⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
  // ———————————No border?———————————
    <div className={`${no_border ? "" : "border-1 border-[var(--primary)]"} transition transform hover:-translate-y-1 motion-reduce:transition-none motion-reduce:hover:transform-none`}>
      <a
      onClick={onClick}
