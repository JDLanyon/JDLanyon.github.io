  ...
  return (
    <section className="min-h-[100vh] flex flex-col">
      ...
      <div id="content" className="px-32 py-8 mt-16">
        ...
        <PanelsFromData id="snippets" category="motion_graphics" heading="Snippets" thumbnails_path="/motion_graphics/snippets/" data={MOTION_GRAPHICS.SNIPPETS} />
        <PanelsFromData id="full-projects" category="motion_graphics" heading="Full Projects" thumbnails_path="/motion_graphics/full_projects/" data={MOTION_GRAPHICS.FULL_PROJECTS} />
