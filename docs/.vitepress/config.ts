...
export default defineConfig({
  ...
  description: 'Software engineer - Python, C#, React and creatively coding clean systems that scale.',
  lang: 'en-AU',
  base: '/',
  cleanUrls: true,
    ...
    socialLinks: [
      {
        ...
        link: 'https://github.com/jdlanyon'
      },
      {
        icon: {
        ...
        link: 'https://linkedin.com/in/jdlanyon'
      },
    ],
